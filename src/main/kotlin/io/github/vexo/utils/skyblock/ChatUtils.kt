 ...
 */
fun modMessage(message: Any?, prefix: String = "§8[§3Vexo§8]§r ", chatStyle: ChatStyle? = null) {
...
fun getCenteredText(text: String): String {
    val textWidth = mc.fontRendererObj.getStringWidth(text.replace(FORMATTING_CODE_PATTERN, ""))
